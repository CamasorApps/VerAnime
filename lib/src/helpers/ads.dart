...
class Ads {
  ...
  static init({Settings settings}) {
    FirebaseAdMob.instance.initialize(appId: _getAppId(settings));
    Admob.initialize();
  }
  ...
  static String _getAdUnitIdBanner(Settings settings) {
    return (Platform.isIOS)
        ? settings.adIosUnitIdBanner ?? 'ca-app-pub-3940256099942544/2934735716'
        : settings.adUnitIdBanner ?? 'ca-app-pub-3940256099942544/6300978111';
  }

  static String _getAdUnitIdInterstitial(Settings settings) {
    return (Platform.isIOS)
        ? settings.adIosUnitIdInterstitial ??
            'ca-app-pub-3940256099942544/4411468910'
        : settings.adUnitIdInterstitial ??
